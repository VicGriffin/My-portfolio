...
import { ArrowUpRight, BriefcaseBusiness, CalendarDays, Database, Layers3, Rocket } from "lucide-react"
import Link from "next/link"

const experiences = [
  { role: "Forward Deployment Engineer", company: "Bricklabs", date: "March 2026 — Present", icon: Rocket, focus: "SautiAI project · forward deployment · product engineering", highlights: ["Working on the SautiAI project as a Forward Deployment Engineer at Bricklabs."] },
