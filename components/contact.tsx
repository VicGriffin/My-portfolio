...
export default function Contact() {
  ...
  const [terminalLines, setTerminalLines] = useState<TerminalLine[]>([
    ...
    { id: 2, text: "Messages route to vickamau20@gmail.com", type: "success" },
  ])
